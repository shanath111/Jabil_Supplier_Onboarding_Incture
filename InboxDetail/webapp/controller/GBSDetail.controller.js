sap.ui.define([
    ...
    function (Controller, library, formatter, JSONModel, Filter, FilterOperator, MessageBox, BusyDialog, Sorter, deepExtend) {
        ...
        return Controller.extend("InboxDetail.controller.GBSDetail", {
            onInit: function () {
                oView = this.getView();
                that = this;
            ...
            fnLoadBlockFunction: function (vBind) {
                var oModel = new JSONModel();
                var sUrl = "/InboxDetail/plcm_reference_data/api/v1/reference-data/block-functions";
                oModel.loadData(sUrl, {
   ...
   window.parent.location.reload();
            ...
            fnLoadPartnerData: function (vActn, vFilter, vSelData) {
                ...
                var sUrl = "/InboxDetail/plcm_portal_services/ehana/search";
                aFilter.limit = 10;
            ...
            fnLoadCaseDetail: function (vCaseID) {
                ...
                var sUrl = "/InboxDetail/plcm_portal_services/case/findById/" + vCaseID
            ...
            fnGBSApprove: function () {
                ...
                oView.getModel("JMCaseDetail").getData().bpSearch.selectedSupplier = JSON.stringify(vBPNo);
                            ...
                            if (oAction == "YES") {
                                ...
                                oModel.attachRequestCompleted(function onCompleted(oEvent) {
                                    if (oEvent.getParameter("success")) {
                                        ...
                                        var sUrl = "/InboxDetail/plcm_portal_services/case/updateBP"
            ...
            fnPersonaliseColumns: function (oEvent) {
                ...
                if (!this.FilterPersonalization) {
                    this.FilterPersonalization = sap.ui.xmlfragment("idPersonaliseDialog", "InboxDetail.fragments.personalizationFilter", this);
